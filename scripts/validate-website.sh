...
website_icon="assets/ossuno-icon-v8.png"
website_icon_dark="assets/ossuno-icon-dark-v8.png"
website_favicon="assets/ossuno-favicon-v8.png"
website_favicon_dark="assets/ossuno-favicon-dark-v8.png"
...
required_files=(
  ...
  "$site_root/$website_icon_dark"
  "$site_root/$website_favicon"
  "$site_root/$website_favicon_dark"
...
required_html=(
  ...
  "href=\"$website_favicon_dark\""
  "href=\"$website_icon\""
  "srcset=\"$website_icon_dark\""
